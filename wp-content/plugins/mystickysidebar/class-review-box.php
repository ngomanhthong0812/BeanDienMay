...
class stickysidebar_form_review_box
{
	 ...
	 * @access public
	 */
	public $pluginName = "WP Sticky Sidebar";
	 ...
	 * @access public
	 */
	public $pluginSlug = "wpstickysidebar";
	 ...
	 * @access public
	 */
	public $wpPluginSlug = "mystickysidebar";
...
//		$this->reviewStatus = true;
	...
	public function enqueue_scripts() {
		if (current_user_can('manage_options')) {
			wp_enqueue_style($this->pluginSlug."-star-rating-svg", plugins_url('css/star-rating-svg.css', __FILE__), [], STICKY_SIDEBAR_VER);
			wp_enqueue_script($this->pluginSlug."-star-rating-svg", plugins_url('js/jquery.star-rating-svg.min.js', __FILE__), ['jquery'], STICKY_SIDEBAR_VER);
		}
	}
	...
	public function admin_notices()
	{
        ...
        <div class="notice notice-info premio-notice <?php echo esc_attr($this->pluginSlug) ?>-premio-review-box">
            ...
            <div class="<?php echo esc_attr($this->pluginSlug) ?>-premio-review-box__default">
                <h2 class="<?php echo esc_attr($this->pluginSlug) ?>-premio-review-box__default__title">
					<?php esc_html_e('Your', 'mystickysidebar') ?> <span><?php esc_html_e('feedback', 'mystickysidebar') ?></span> <?php esc_html_e('matters, please leave a review', 'mystickysidebar') ?> 🙏
                </h2>
                ...
                <p><?php printf( esc_html__("Hi there, it seems like %s is bringing you some value, and that's pretty awesome! Can you please show us some love and rate %s on WordPress? It'll only take 2 minutes of your time, and will really help us spread the word", 'mystickysidebar'), "<b>".$this->pluginName."</b>", $this->pluginName);?></p>

                <div class="<?php echo esc_attr($this->pluginSlug) ?>-premio-review-box__default__co-founder">
                    <span>
                        <b><?php esc_html_e('Gal Dubinski', 'mystickysidebar') ?></b>,
                        <?php esc_html_e('Co-founder', 'mystickysidebar') ?>
                    </span>
                    <img class="<?php echo esc_attr($this->pluginSlug) ?>-premio-review-box__default__co-founder-img" width="30" height="30" src="<?php echo esc_url(STICKY_SIDEBAR_URL."images/premio-owner.png") ?>" />
                </div>
            ...
            <div class="<?php echo esc_attr($this->pluginSlug) ?>-premio-review-box__thank-you">
                <div class="thanks-wrap">
                    ...
                    <img class="<?php echo esc_attr($this->pluginSlug) ?>-premio-review-box__thank-you__image" width="200" src="<?php echo esc_url(STICKY_SIDEBAR_URL."images/thanks.gif") ?>" />

                    <div class="<?php echo esc_attr($this->pluginSlug) ?>-premio-review-box__thank-you__message">
                        <div class="title"><?php esc_html_e("You are awesome ", 'mystickysidebar')?> &#128591;</div>
                        <div class="desc"><?php esc_html_e("Thanks for your support, we really appreciate it!", 'mystickysidebar')?></div>
                        <div class="footer"><?php esc_html_e("Premio team ", 'mystickysidebar')?></div>
                    </div>
                </div>
            ...
            <div class="<?php echo esc_attr($this->pluginSlug) ?>-review-box-popup">
                <div class="<?php echo esc_attr($this->pluginSlug) ?>-review-box-popup__content">
                    ...
                    <div class="<?php echo esc_attr($this->pluginSlug) ?>-review-box-popup__options">
                        <a href="#" data-days="3"><?php esc_html_e("Remind me in 3 days ", 'mystickysidebar')?></a>
                        <a href="#" data-days="10"><?php esc_html_e("Remind me in 10 days ", 'mystickysidebar')?></a>
                        <a href="#" data-days="-1" class="dismiss"><?php esc_html_e("Don't remind me about this ", 'mystickysidebar')?></a>
                    </div>
                </div>
            ...
            <div class="<?php echo esc_attr($this->pluginSlug) ?>-feedback-popup">
                <div class="<?php echo esc_attr($this->pluginSlug) ?>-feedback-popup__content">
                    ...
                    <form class="<?php echo esc_attr($this->pluginSlug) ?>-feedback-popup__form">
                        ...
                        <button id="submit-btn" type="submit"><?php esc_html_e('Submit', 'mystickysidebar') ?></button>
                    </form>
                </div>
        ...
        <script>
            (function($) {
                function StickySidebarFreeReview() {
                ...
                StickySidebarFreeReview.prototype.getSelectors = function() {
                    return {
                        body: 'body',
                ...
                StickySidebarFreeReview.prototype.getElements = function() {
                ...
                StickySidebarFreeReview.prototype.bindEvents = function() {
                ...
                StickySidebarFreeReview.prototype.feedbackFormHandler = function(ev) {
                    ev.preventDefault();
                    const elements  = this.getElements();
                ...
                StickySidebarFreeReview.prototype.thankYouDismissHandler = function() {
                    const elements = this.getElements();
                    elements.$reviewBox.remove();
                    elements.$reminderPopup.remove();
                    this.sendHideRequest( -1 );
                ...
                StickySidebarFreeReview.prototype.reminderHandler = function(ev) {
                    ev.preventDefault();
                ...
                StickySidebarFreeReview.prototype.sendHideRequest = function( dataDays = -1 ) {
                    $.ajax({
                        url: "<?php echo admin_url("admin-ajax.php") ?>",
                ...
                StickySidebarFreeReview.prototype.toggleReminderPopup = function( action = true ) {
                    if( action ) {
                ...
                StickySidebarFreeReview.prototype.feedbackToggle = function( action = true ) {
                    const elements = this.getElements();
                    console.log(action);
                    if( action ) {
                ...
                StickySidebarFreeReview.prototype.renderRating = function() {
                    const self      = this;
...
$stickysidebar_form_review_box = new stickysidebar_form_review_box();
