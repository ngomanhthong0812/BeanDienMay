            ...
            $('.recommeded-plugins-hide').on('click', function (event) {
                ...
                $("#hide-recommeded-plugins").dialog({
                    ...
                    buttons: {
                        "Hide it": {
                            click: function () {
                                window.location = "<?php echo admin_url('admin.php?page=my-stickysidebar-settings&hide_my_sticky_sidebar_plugins=1&mss_nonce='.wp_create_nonce('hide_my_sticky_sidebar_plugins'));?>";
                            },
                            text: 'Hide it',
                            class: 'btn red-btn'
                        },
