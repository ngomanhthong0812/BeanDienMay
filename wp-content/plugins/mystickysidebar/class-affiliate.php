...
<?php
class Sticky_Sidebar_affiliate_program {
    ...
    public function admin_notices() {
        if (current_user_can('manage_options')) {
            ...
            <div class="notice notice-info <?php echo esc_attr($this->plugin_slug) ?>-premio-affiliate <?php echo esc_attr($this->plugin_slug) ?>-premio-affiliate">
                <p>
                    <?php printf(esc_html__("Hi there, you've been using %s for a while now. Do you know that %s has an affiliate program? Join now and get %s"), "<b>".$this->plugin_name."</b>", "<b>".$this->plugin_name."</b>", "<b>25% lifetime commission</b>") ?>
            ...
            <div class="<?php echo esc_attr($this->plugin_slug) ?>-affiliate-popup">
                <div class="<?php echo esc_attr($this->plugin_slug) ?>-affiliate-popup-content">
                    ...
                    <div class="<?php echo esc_attr($this->plugin_slug) ?>-affiliate-title"><?php esc_html_e("Would you like us to remind  you about this later?", 'stars-testimonials') ?></div>
...
$Sticky_Sidebar_affiliate_program = new Sticky_Sidebar_affiliate_program();